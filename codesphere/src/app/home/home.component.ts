...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  articles: Article[] = [
    {
      ...
      category: 'Typescript',
      title:
        'Khóa học Typescript từ zero đến hero dành cho người mới bắt đầu - Học để trở thành master trong sự nghiệp IT trong vòng 2 tuần',
      link: '/font-tet',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      category: 'Front-end',
      title:
        'Lập trình giao diện với Angular 13, thiết kế trang thương mại điện tử',
      link: '/giao-duc',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      category: 'Core',
      title:
        'Khóa học Typescript - full project sử dụng typescript trong 2 ngày',
      link: '/tu-khoa-hot',
    },
  ...
  goToPage(page: number) {
    if (page !== this.currentPage) {
      this.animationState =
        page > this.currentPage ? 'rightToLeft' : 'leftToRight';
